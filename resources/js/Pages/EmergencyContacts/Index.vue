        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-6 py-10">
                    <h1 class="text-2xl font-bold uppercase mb-3">Listado de Contactos de Emergencia</h1>
                    <DataTable
                        ...
                        :routeTrash="'emergency_contacts.trash'"
                        :routeShow="{route: 'emergency_contacts.show'}"
                        :routeDestroy="{route: 'emergency_contacts.destroy'}" />
                </div>
            </div>
        </div>
    </AppLayout>
